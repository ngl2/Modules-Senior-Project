...
class Suppliers extends Person_controller
{
	...
	# function to return supplier table rows
	function search()
	{
	...
	# function to add or update a supplier
	function save($supplier_id=-1)
	{
		...
		if($this->Supplier->save($person_data,$supplier_data,$supplier_id))
		{
			...
			else # not new then maybe existing
			{
	...
	# get width of supplier edit form
